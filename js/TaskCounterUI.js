...
TaskCounterUI.prototype.bindEvents = function () {
  document.addEventListener(this.list.eventKeys.taskAdded, this.update.bind(this));
  document.addEventListener(this.list.eventKeys.taskRemoved, this.update.bind(this));
};
